...
var ordersVue = new Vue({
  ...
  methods: {
      ...
      // 降序排序规则
      compareDescRule: function (price,number) {
          var that = this;
      ...
      // 升序排序规则
      compareAscRule: function (price,number) {
          var that = this;
          var a = function(a,b){
              var value1 = a[price];
              var value2 = b[price];
